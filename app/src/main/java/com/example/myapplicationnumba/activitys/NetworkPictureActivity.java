...
public class NetworkPictureActivity extends AppCompatActivity {
...
//        loadUrlImage("https://securitylab.github.com/static/90581ce5ce63352693e23bb77edda612/fddbb/ctf4.png");
//        loadUrlImage("https://www.imooc.com/static/img/index/logo.png");
//        但是当网络图片过大时，会导致我们生成的bitmap所占用的内存过多，从而导致 OOM
//        https://securitylab.github.com/static/90581ce5ce63352693e23bb77edda612/fddbb/ctf4.png
...
//                    打印失败的状态码
                    Toast.makeText(NetworkPictureActivity.this, "code: " + msg.what , Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
